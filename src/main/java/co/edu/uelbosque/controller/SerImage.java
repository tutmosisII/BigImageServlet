 ...
 * @author aleon
 */
@WebServlet(name = "SerImage", urlPatterns = {"/SerImage"})
public class SerImage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SerImage.class.getName()).log(Level.SEVERE, null, ex);
        } 
